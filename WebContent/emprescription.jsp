...
<br><br><br><br><br>
	<form action="empresc" method="post"><br><br>
	<table>
	<tr>
	<td>Name:</td>
	...
	<a href="http://localhost:8080/HospitalManagement/emdoc.jsp">BACK</a><br/>
	<a href="http://localhost:8080/HospitalManagement/emdoclogin.jsp">Log Out</a><br/>
