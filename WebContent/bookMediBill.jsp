...
<body background="C:\Users\gvsan\Desktop\Hospital.jpg">
		...
		try
		{
			...
			PreparedStatement statement2 = connection.prepareStatement("INSERT INTO bill(datebill,medicine,amount,custname) VALUES(?,?,?,?)") ;
			PreparedStatement statement3 = connection.prepareStatement("INSERT INTO bookedmedi(name,mediname,quantity) VALUES(?,?,?)") ;
			...
			statement2.setDouble(3,custprice);
			statement2.setString(4,custname);
			statement2.executeUpdate();
			
			statement3.setString(2,medname);
			statement3.setInt(3,Integer.parseInt(quantity));
			statement3.setString(1,custname);
