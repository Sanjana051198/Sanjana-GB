...
public class createacc extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String userid=request.getParameter("patientname");
		...
		try
		{
			...
			PreparedStatement statement = connection.prepareStatement("INSERT INTO patient(patientnamepat,useridpat,passwordpat,curdoctorpat,curpurposepat,sexpat,emailpat,addresspat,phonenumpat,agepat)"
					+ " VALUES(?,?,?,?,?,?,?,?,?,?)") ;
