...
/**
 * Servlet implementation class addmei
 */
@WebServlet("/addmedi")
public class addmedi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement statement = connection.prepareStatement("INSERT INTO pharma(medicinenamepharma,availibilitypharma,priceperunitpharma,alternativepharma,medpurposepharma)"
					+ " VALUES(?,?,?,?,?)") ;
